...
wd=[root_code_path fs 'fconn_matrices_tools' fs 'parcel_gordon'];
cd(wd)
%% Load parent parcel

load('Gordon_parcel.mat')

%% Read ROI names

tidyData_filename=[wd fs 'Gordon_PD25.dlabel.csv'];
Dictionary_filename=[wd fs 'dictionary_Gordon_PD25.dlabel.csv'];
...
%% Rename and save
parcel=newParcel;
save('Gordon_PD25.mat','parcel');
T = parcel_str2table(parcel);
writetable(T,'Gordon_PD25.csv')