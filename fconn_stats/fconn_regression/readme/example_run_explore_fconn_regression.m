...
options.zscoring=[0];
options.resort_parcel_order=[1 2 3];%
options.N=1e2;
options.N_Null=1e3;
options.save_data=1;
options.scout_up_to=4;
options.symmetrize=1;
options.n_comp_to_keep=[2 3 5];
rng('shuffle')

%%

run_explore_fconn_regression(path_imaging_training,...
    ...
    'path_imaging_prediction',path_imaging_prediction,...
    'path_demographics_Table_prediction',path_demographics_Table_prediction,...
    'path_dictionary_demographics_Table_prediction',path_dictionary_demographics_Table_prediction,...
    'path_group_Design_Table_prediction',path_group_Design_Table_prediction,...
