function run_optimized_fconn_regression(path_imaging_training,...
...
output_folder=[pwd fs 'output_optimized_fconn_regression'];
...
[X2,within_headers,y2]=get_X_y_for_fconn_regression(path_imaging,...
    ...
    options);
%% run test
scout_parameters_fconn_regression(X1,within_headers,y1,options,X2,y2);
cd(from_wd)
